...
def run():
    ...
    print("-" * 50)
    print(f"FA Mean: {mean_fa:.6f} bytes")
    print(f"FA Standard Deviation: {std_fa:.6f} bytes")
    print(f"FA Variance: {var_fa:.6f} bytes²")
    print(f"\nEFA Mean: {mean_efa:.6f} bytes")
    print(f"EFA Standard Deviation: {std_efa:.6f} bytes")
    print(f"EFA Variance: {var_efa:.6f} bytes²")
    print("\n" + "-" * 50)
    print("Statistical Results:")
    print("-" * 50)
    print(f"Mean Difference: {mean_diff:.6f} bytes")
    print(f"Standard Deviation (Diff): {std_diff:.6f} bytes")
    print(f"Variance (Diff): {var_diff:.6f} bytes²")
    ...
    with open(results_path, "w") as f:
        ...
        f.write("-" * 50 + "\n")
        f.write(f"FA Mean: {mean_fa} bytes\n")
        f.write(f"FA Standard Deviation: {std_fa} bytes\n")
        f.write(f"FA Variance: {var_fa} bytes²\n")
        f.write(f"\nEFA Mean: {mean_efa} bytes\n")
        f.write(f"EFA Standard Deviation: {std_efa} bytes\n")
        f.write(f"EFA Variance: {var_efa} bytes²\n\n")
        f.write("Statistical Results:\n")
        f.write("-" * 50 + "\n")
        f.write(f"Mean Difference: {mean_diff} bytes\n")
        f.write(f"Standard Deviation (Diff): {std_diff} bytes\n")
        f.write(f"Variance (Diff): {var_diff} bytes²\n")
